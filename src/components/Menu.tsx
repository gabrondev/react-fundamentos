import { IconArrowDownSquare, IconArrowUpSquare, IconBraces, IconBrandJavascript, IconCalculator, IconCode, IconFileCheck, IconForms, IconFunction, IconH1, IconNumber99Small, IconSitemap } from "@tabler/icons-react";
...
export default function Menu() {
    return (
        ...
        `}>
            ...
            <MenuItem icone={<IconNumber99Small />} texto="Contador" url="/estado/contadorResposta" />
